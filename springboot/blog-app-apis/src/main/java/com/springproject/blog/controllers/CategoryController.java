...
public class CategoryController {
	...
	@PutMapping("/{catId}")
	 public ResponseEntity<CategoryDto> updateCategory(@Valid @RequestBody CategoryDto categoryDto,@PathVariable Integer catId){
		CategoryDto updated  = this.categoryService.updateCategory(categoryDto, catId);
	...
	public ResponseEntity<CategoryDto> getSingleCategory(@PathVariable Integer catId ){
		CategoryDto getSingle = this.categoryService.getCategory(catId);
		return new ResponseEntity<CategoryDto>(getSingle,HttpStatus.OK);
